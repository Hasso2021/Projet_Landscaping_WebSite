        ...
        >
          ...
          <div className="relative grid items-center gap-6 lg:grid-cols-[1fr_auto]">
            <div className="space-y-4 text-white">
              <h3 className="text-3xl font-bold leading-tight lg:text-4xl">Looking for reliable landscape maintenance in Dublin?</h3>
            ...
            <Link
              to="/contact"
              className="inline-flex h-12 items-center justify-center rounded-md bg-white px-6 text-base font-semibold text-[#1f5d22] transition hover:bg-emerald-50"
            >
