  ...
  return (
    <section className="w-full bg-white pb-24 pt-36 lg:pt-40">
      <div className="mx-auto grid w-full max-w-7xl grid-cols-12 gap-12 px-6">
        ...
        <div className="col-span-12 grid gap-5 md:grid-cols-2 lg:col-span-8">
          {SERVICES.map(({ title, description, Icon }) => (
            <article
              key={title}
              className="rounded-2xl bg-white p-6 shadow-md transition duration-300 hover:-translate-y-[5px] hover:shadow-xl"
            >
